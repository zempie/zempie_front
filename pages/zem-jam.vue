        ...
        <div class="container" ref="eventRef">
            ...
            <div class="slogan">
                <div style=" font-family: 'Press Start 2P';">
                    <h1 style=" font-family: 'Press Start 2P';" data-scroll data-scroll-speed="1"
                        data-scroll-delay="0.05">
                        WELCOME TO ZEM JAM</h1>
                    ...
                    <div data-scroll data-scroll-speed="1.9" data-scroll-delay="0.05" data-scroll-direction=""
                        ...
                        <a style="font-family:'Russo One', 'NeoDunggeunmo';">종료된 게임젬</a>
            ...
            <div class="game-submission">
                <div>
                    <h2 data-scroll data-scroll-speed="1" data-scroll-delay="0.05">GAME SUBMISSION IS OPEN</h2>
                    <h3 data-scroll data-scroll-speed="1.3" data-scroll-delay="0.05"
                        style=" font-family:'Russo One', 'NeoDunggeunmo'">
                        FROM APRIL 1 TO APRIL 11!</h3>
            ...
            <div class="footer">
                <div>
                    ...
                    <div>
                        FROMtheRED Inc. <span>|</span> CEO : SeoSangWook <span>|</span> Company registration number :
                        178-88-00617
                        <br />
                        Address : Seoul, Seodaemun-go, 105 Bughyun-ro,3rd floor <span>|</span> Email :
                        support@fromthered.com
                        <br />
                        <br />
...
.container {
    width: 100%;
    background: url('/images/bg.jpg') center top no-repeat, #020822;
}
...
@media all and (max-width: 479px) {
    .out-partner {
        background: url('/images/partner_bg.jpg') -920px top no-repeat, #01071F;
...
@media all and (min-width: 480px) and (max-width: 767px) {
    .out-partner {
        background: url('/images/partner_bg.jpg') -600px top no-repeat, #01071F;
        background-size: cover;
    }
...
body {
    font-family: 'Russo One', 'Press Start 2P' !important;
}
