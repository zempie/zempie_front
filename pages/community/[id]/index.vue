...
async function fetch() {
  ...
  const { data, pending } = await useFetch<any>(() => createQueryUrl(`/community/list`, query), { method: 'get', baseURL: config.COMMUNITY_API, headers: accessToken ? { 'Authorization': `Bearer ${accessToken}` } : {} })
